...
?><nav class="pagination-container d-flex justify-content-between"><?
	...
	if($arResult["bDescPageNumbering"] === true):
		...
		<ul class="pagination pagination-sm"><?
			if ($arResult["NavPageNomer"] > 1):
				if($arResult["bSavePage"]):
					?><li class="page-item 1"><a class="page-link" href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=($arResult["NavPageNomer"]-1)?>"><?=GetMessage("MAIN_UI_PAGINATION__PREV")?></a></li><?
				else:
					if ($arResult["NavPageNomer"] > 2):
						?><li class="page-item 1"><a class="page-link" href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=($arResult["NavPageNomer"]-1)?>"><?=GetMessage("MAIN_UI_PAGINATION__PREV")?></a></li><?
					else:
						?><li class="page-item 2"><a class="page-link" href="<?=$arResult["sUrlPath"]?><?=$strNavQueryStringFull?>"><?=GetMessage("MAIN_UI_PAGINATION__PREV")?></a></li><?
					endif;
				endif;
			else:
